...
public class LinkedPositionalList<E> implements PositionalList<E> {
   ...
   * @return the Position representing the location of the new element
   */
  Position<E> addLast1(E e) {
    if (isEmpty()) {
      return addFirst(e);
    }
    return addAfter(last(), e); // Insert the new element after the current last element
  }
   ...
   * @throws IllegalArgumentException if p is not a valid position for this list
   */
  Position<E> addBefore1(Position<E> p, E e)
      throws IllegalArgumentException {
    // If position p is the first position in the list. Insert the new element at
    // the beginning of the list
    if (p == first()) {
      return addFirst(e);
    }
    // Add 'e' after the position before 'p'
