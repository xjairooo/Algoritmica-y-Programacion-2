...
public class SinglyLinkedList<E> implements Cloneable {
	 ...
	 * 
	 * @param odd si es true incluye los elementos que est�n en la ubicaci�n impar
	 *            si es false incluye los elementos que est�n en la ubicaci�n par
	 *            
	 ...
	 * alternate(false) => {B, D}
	 * 
	 * Nota: este m�todo no modifica la lista original
	 * 
	 */
