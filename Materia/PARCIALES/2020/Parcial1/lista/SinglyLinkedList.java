...
public class SinglyLinkedList<E> implements Cloneable {
	...
	/* Elimina (nro) elemento comenzando de la posición (pos) de la lista */
	/* Si la acción no es válida lanza la excepción: IndexOutOfBoundsException */

	/*
	 * Por ejemplo dada la lista {A, B, C, D, E} removePos(2,3) => {A, E}
	 * removePos(1,2) => {C, D, E} removePos(5,1) => {A, B, C, D} removePos(5,2)
	 * => IndexOutOfBoundsException removePos(0,2) => IndexOutOfBoundsException
	 * 
	 * El ejemplo muestra que elementos quedan en la lista original después de
	 * llamar al método removePos.
	 */
	public void removePos(int pos, int nro) {
		if (pos < 1 || pos > size)
			throw new IndexOutOfBoundsException("Posición inválida");
		if (nro < 1 || nro > size - pos + 1)
			throw new IndexOutOfBoundsException("Posición inválida");
