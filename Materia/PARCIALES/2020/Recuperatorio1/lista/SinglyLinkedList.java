...
public class SinglyLinkedList<E> implements Cloneable {
	...
	/*
	 * Retorna una nueva lista como resultado de la union de dos listas. Ninguna
	 * lista tiene elemento duplicados. La nueva lista retornada tampoco tiene
	 ...
	 * { A, S, D } { W, S, X }
	 * 
	 * El método union retorna una nueva lista con los elementos
	 * 
	 * { A, S, D, W, X }
	 */
	public SinglyLinkedList<E> union(SinglyLinkedList<E> l) {
		SinglyLinkedList<E> c = new SinglyLinkedList<E>();

		Node<E> walk = head;
		while (walk != null) {
			c.addLast(walk.getElement());
			walk = walk.getNext();
		}
		walk = l.head;
		while (walk != null) {
			 if (search(walk.getElement()) == null)		
				c.addLast(walk.getElement());
			walk = walk.getNext();
		}
		return c;
