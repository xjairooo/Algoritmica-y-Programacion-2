...
public class DoublyLinkedList<E> {
	 ...
	 *
	 * Por ejemplo, para una lista que contiene los siguientes elementos:
	 *
	 * (rojo, azul, blanco, azul, azul, amarillo, verde)
	 * 
	 * si el elemento buscado en la lista es: azul
	 * 
	 * el método retorna el valor: 5
	 *
	 */
	...
	/*
	 * Busca el elemento e dentro de la lista Retorna el elemnto si lo encuentra o
	 * Null si no esta en la lista
	 */
	public E search(E e) {
		Node<E> walk = header.getNext();
		while (walk != trailer) {
	...
	/*
	 * Retiene en la lista todos los elementos que están en "list" y elimina lo que
	 * no están en la misma.
	 * 
	 * Considere implementar un método para buscar elementos (searh) que se invoca
	 * desde retainAll para hacer el código más claro
	 * 
	 * Por ejemplo, para una lista que contiene los siguientes elementos:
	 * 
	 * (rojo, azul, blanco, azul, azul, amarillo, verde)
	 * 
	 * se pide retener los elementos de la siguiente lista:
	 * 
	 * (rojo, azul, amarillo)
	 * 
	 * la lista resultante es:
	 * 
	 * (rojo, azul, azul, azul, amarillo)
	 *
	 */
	public void retainAll(DoublyLinkedList<E> list) {

		Node<E> walk = header.getNext();
		while (walk != trailer) {
			if (list.search(walk.getElement()) == null)
				remove(walk);
			walk = walk.getNext();
		}
	}
