...
public class ArrayList<E> implements List<E> {
	...
	/**
	 * Retorna una lista nueva con los elementos especificados en fromIndex
	 * inclusive (incluye la posición dada) y toIndex exclusive (es uno menor a la
	 * posición dada). Si fromIndex y toIndex son iguales, retorna una lista vacía.
	 * 
	 * @param fromIndex elemento inicial inclusive (incluye la posición dada) de
	 *                  subList
	 ...
	 * 
	 * Notar que incluye el elemento que está en la posición 2 (incluive) y no
	 * incluye el elemento que está en la posición 4 (exclusive)
	 * 
	 */
	@Override
