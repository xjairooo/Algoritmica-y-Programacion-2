...
public class LinkedPositionalList<E> implements PositionalList<E> {
	 ...
	 * @return the Position representing the location of the new element
	 */
	public Position<E> addLastNew(E e) {
		return addAfter(last(), e); // just before the trailer
	}
	 ...
	 * @throws IllegalArgumentException if p is not a valid position for this list
	 */
	public Position<E> addBeforeNew(Position<E> p, E e) throws IllegalArgumentException {
	 ...
	 */
	public PositionalList<Position<E>> findAllPosition(E e) {
		PositionalList<Position<E>> pl = new LinkedPositionalList<Position<E>>();
		if (isEmpty())
			return pl;
		Position<E> q = first();
		while (q != null) {
			if (q.getElement().equals(e))
				pl.addLast(q);
			q = after(q);
		}
		return pl;
	...
	@Override
	public PositionalList<E> newPositionalList(Iterable<E> iterable) {
		PositionalList<E> pl = new LinkedPositionalList<E>();
		for (E e : iterable)
			pl.addLast(e);
		return pl;
	}
