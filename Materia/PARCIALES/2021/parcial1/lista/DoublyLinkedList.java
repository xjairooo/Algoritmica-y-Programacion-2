...
public class DoublyLinkedList<E> {
	...
	/*
	 * Retorna true si el primer elemento es igual al último, el segundo al
	 * anteúltimo y así sucesivamente con todos los elementos de la lista
	 * 
	 * Si la lista está vacía retorna false
	 *
	 * Por ejemplo, dada la lista que contiene las letras
	 * 
	 * (n, e, u , q, u, e, n)
	 *
	 * El método palindrome retorna true
	 * 
	 *
	 */
