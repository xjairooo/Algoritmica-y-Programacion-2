...
public class SinglyLinkedList<E> implements Cloneable {
	...
	public SinglyLinkedList<E> clone() throws CloneNotSupportedException {
		...
		if (size > 0) { // we need independent chain of nodes
			other.head = new Node<>(cloneElement(head.getElement()), null);
			Node<E> walk = head.getNext(); // walk through remainder of original
											// list
			other.tail = other.head; // remember most recently created
										// node
			while (walk != null) { // make a new node storing same element
				Node<E> newest = new Node<>(cloneElement(walk.getElement()),
						null);
				other.tail.setNext(newest); // link previous node to this one
				other.tail = newest;
				walk = walk.getNext();
			}
		}
	...
	/* Retorna una nueva lista con todos los elementos de fromIndex a toIndex inclusive */
	/* Si fromIndex <0 o toIndex >= al tamaño de la lista, lanza la excepcion: IndexOutOfBoundsException  */
