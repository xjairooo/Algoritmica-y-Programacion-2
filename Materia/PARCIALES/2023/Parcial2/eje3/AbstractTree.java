...
public abstract class AbstractTree<E> implements Tree<E> {
	 ...
	 * la rama son todos los nodos internos hasta llegar a la raíz
	 */
	public Map<Position<E>, List<Position<E>>> branchMap() {
		Map<Position<E>, List<Position<E>>> map = new ProbeHashMap<Position<E>, List<Position<E>>>();

		for (Position<E> p : externals()) {
			List<Position<E>> list = new ArrayList<Position<E>>();
			map.put(p, list);
