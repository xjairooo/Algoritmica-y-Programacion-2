...
public class TestAddList {
    ...
    public static void testAddList1() {
        ...
        l1.addList(l2, 2);
        System.out.println();
        System.out.println(l1 + " Size: " + l1.size()); // Salida esperada: [A, B, X, Y, C, D] Size: 6
    }
    ...
    public static void testAddList2() {
        ...
        l1.addList(l2, 0);
        System.out.println(l1 + " Size: " + l1.size()); // Salida esperada: [X, Y, A, B, C, D] Size: 6
    }
    ...
    public static void testAddList3() {
        ...
        l1.addList(l2, 4);
        System.out.println(l1 + " Size: " + l1.size()); // Salida esperada: [A, B, C, D, X, Y] Size: 6
    }
    ...
    public static void testAddList4() {
        ...
        l1.addList(l2, 2);
        System.out.println(l1 + " Size: " + l1.size()); // Salida esperada: [A, B, C, D] Size: 4
    }
    ...
    public static void testAddList5() {
        ...
        l1.addList(l2, 0);
        System.out.println(l1 + " Size: " + l1.size()); // Salida esperada: [X, Y] Size: 2
    }
    ...
    public static void testAddList6() {
        ...
        // Salida esperada: [A, B, C, D, X, Y] Size: 6
        try {
            l1.addList(l2, -1);
