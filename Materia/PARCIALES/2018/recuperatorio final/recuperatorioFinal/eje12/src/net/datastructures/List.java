...
public interface List<E> extends Iterable<E> {
	...
	boolean removeAll(Iterable<E> i);
	
	int indexOf(E e);
	
	boolean retainAll(List<E> l);
	
	boolean addAll(int i, List<E> l) throws IndexOutOfBoundsException;
	
	boolean addAll2(int i, List<E> l) throws IndexOutOfBoundsException;
